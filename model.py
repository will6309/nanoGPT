...
class GPT(nn.Module):
    def __init__(self, config):
        super().__init__()
        # Ensure the configuration specifies vocab_size and block_size
        ...
        # Weight tying: Share weights between token embedding and language modeling head
        self.transformer.wte.weight = self.lm_head.weight

        # Initialize all weights in the model
        self.apply(self._init_weights)

        # Apply special initialization for residual projections as per GPT-2 paper
    ...
    def get_num_params(self, non_embedding=True):
        ...
        If non_embedding is True, exclude position embedding parameters.
        """
    ...
    def forward(self, idx, targets=None):
        ...
        if targets is not None:
            # Calculate logits and loss if targets are provided
    ...
    def crop_block_size(self, block_size):
        """
        Reduce the block size of the model (e.g., for smaller models).
        """
    ...
    def from_pretrained(cls, model_type, override_args=None):
        """
        Load a pretrained GPT model and initialize its weights.
        Args:
            model_type: Type of GPT model (e.g., 'gpt2', 'gpt2-medium')
            override_args: Arguments to override in the configuration
        Returns:
            model: Initialized GPT model
        """
        ...
        # Define configuration based on model type
        config_args = {
